...
export default function Home() {
    ...
    if (typeof window !== "undefined") {
      const ctx = gsap.context(() => {
        ...
        revealText.forEach((char) => {
          const infoContentText = new SplitType(char as HTMLElement, {
            types: "chars,words",
          });
  ...
  return (
    <>
      <div
        className="min-h-screen flex flex-col font-poppins bg-white"
        ref={elementsRef}
      >
              ...
              <div className="flex flex-col lg:flex-row items-center justify-between w-full mb-8 lg:mb-0 ">
                <div className="text-container lg:w-1/2 mb-8 lg:mb-0 text-center lg:text-left">
                  ...
                  <p className="sub-text text-2xl sm:text-2xl mb-6 lg:mb-0 text-[#4caf50]">
                    When gender equality thrives, so does the planet—unleashing
                    the full potential of humanity to combat the climate crisis
                  </p>
                </div>
          ...
          <div className="contentWrapper">
                  ...
                  <div className="md:col-span-2 space-y-4">
                    ...
                    <p className="text-[#276749] reveal-text text-lg">
                      ...
                      <a
                        ...
                        href=" https://akzente.giz.de/en/climate-crisis-gender-women#climate-gender "
                        target="_blank"
                      >
            ...
            <section className="w-full py-12 md:py-24 lg:py-32 bg-[#d4edda] first-section">
              <div className="px-4 md:px-6">
                ...
                >
                  Climate Change: A Catalyst for Gender Inequality and
                  Vulnerability Among Women and Girls
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start text-[#4a235a]">
                  ...
                  <div className="space-y-4">
                    <p className=" text-[#4a235a] reveal-text text-lg">
                      Climate-related disasters severely impact women and girls,
                      undermining their economic and educational opportunities
                      while increasing their vulnerability to gender-based
                      violence (GBV) and health risks. Scarcity of essential
                      resources affects menstrual health and forces difficult
                      choices, such as sacrificing food or facing early
                      marriages. Displacement heightens risks of exploitation,
                      particularly in rural communities where women manage
                      resource collection and family care.
                    </p>
                    <p className=" text-[#4a235a] reveal-text text-lg">
                      As climate stressors worsen, many women remain immobilized
                      by domestic responsibilities, while men migrate for work,
                      reinforcing gender inequalities. In regions like East
                      Africa and the MENA, climate events amplify GBV risks,
                      leading to higher rates of intimate partner violence and
                      harmful practices.
                    </p>
                    <br />
                    <p className="text-[#4a235a]  reveal-text text-md">
                      ...
                      <a
                        className="text-sky-400 after:content-['_↗'] ..."
                        href=" https://gbvaor.net/sites/default/files/2021-03/gbv-aor-helpdesk-climate-change-gbv-19032021.pdf "
                        target="_blank"
                      >
                ...
                <div className="mt-12  text-[#4a235a]">
                  ...
                  <p className="reveal-text text-xl">
                    A practical solution to address the impact of climate change
                    on women and girls could be the establishment of community
                    resilience hubs: partnering with local organizations to
                    provide safe spaces for women and girls during crises,
                    offering shelter and support services; creating local
                    centers that provide access to essential resources, such as
                    menstrual health products, food supplies, and water
                    purification systems; implementing educational workshops
                    that teach women and girls about climate change, their
                    rights, and available resources; and establishing support
                    groups that connect women to share experiences and
                    strategies for coping with climate impacts and GBV.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="py-16 bg-[#F4E7FF] second-section">
              <div className="mx-auto px-4">
                <h2
                  id="headL3"
                  className="text-4xl md:text-5xl font-extrabold text-center mb-12 text-[#4a235a] headline-text"
                >
                  The Health Crisis at the Intersection of Gender Inequality and
                  Climate Change
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                  <div className="space-y-6 text-[#276749]">
                    <p className="reveal-text text-lg">
                      ...
                      exacerbates existing health risks, such as increased
                      maternal and child health issues. Research indicates that
                      rising temperatures can lead to higher rates of
                      stillbirths and contribute to the spread of vector-borne
                      diseases like malaria and dengue fever, which adversely
                      affect maternal and neonatal outcomes. Women often face
                      limited access to healthcare facilities, making them more
                      susceptible to injuries and decreasing their overall
                      survival rates. During climate-related disasters, their
                    ...
                    <p className="reveal-text text-lg[">
                      ...
                      resources, and training, they are less prepared to respond
                      to health crises or disasters. This disparity is
                      particularly evident among marginalized groups, such as
                      Afro-descendent women, who often receive less training and
                      support. As a result, the ongoing climate crisis not only
                      threatens women&apos;s immediate health but also
                      perpetuates intergenerational cycles of poor health and
                      reduced quality of life for future generations. Addressing
                      these challenges is crucial for promoting gender equality
                      and improving health outcomes in the face of climate
                      change.
                    </p>
                    <br />
                    <p className="text-[#4a235a]  reveal-text text-md">
                ...
                <div className="mt-12 space-y-6 text-[#276749]">
                  ...
                  <p className="reveal-text text-xl">
                    Offering training sessions for women in rural areas on
                    sustainable agricultural practices, resource management, and
                    climate adaptation strategies, prioritizing reproductive
                    health services, including family planning and maternal
                    care, and providing financial support for girls&apos;
                    education, focusing on STEM subjects to equip them with
                    skills relevant to climate science and sustainability.
                  </p>
                </div>
              </div>
            </section>

            <section className="py-8 md:py-16 bg-[#d4edda] third-section">
              <div className="mx-auto px-4">
              <h2
                  id="headL4"
                  className="text-4xl md:text-5xl font-extrabold text-center mb-12 text-[#276749] headline-text"
                >
                ...
                <div className="space-y-8 md:space-y-12 text-[#4a235a]">
                  <div className="mx-auto">
                    <p className="md:text-base leading-relaxed reveal-text text-lg">
                      ...
                      agriculture, water collection, and household care, women
                      are more vulnerable to climate-related events like
                      droughts and floods. For instance, in Sub-Saharan Africa,
                      women produce 60-80% of food but often lack equal access
                      to resources and land rights, exacerbating food
                      insecurity. This vulnerability is further compounded by
                      increased workloads and limited decision-making power,
                    ...
                    <p className="mt-4 text-lg md:text-base leading-relaxed reveal-text">
                      ...
                      contribute effectively to climate solutions. Policies that
                      prioritize gender-responsive climate financing, improve
                      access to resources, and promote women&apos;s leadership
                      in decision-making can drive positive outcomes. By
                      integrating gender equality into climate action, we not
                      only empower women but also strengthen community
                  ...
                  <div className="relative h-[70vh] aspect-w-16 aspect-h-9 max-w-4xl mx-auto my-8 overflow-hidden">
                    <Image
                      src={omniaPic}
                  ...
                  <div className="mx-auto">
                    <h3 className="text-2xl md:text-3xl text-[#276749] font-bold mb-4">
                      Practical Solutions
                    </h3>
                    <p className="text-lg md:text-base lg:text-xl reveal-text">
                      Offering training sessions for women in rural areas on
                      sustainable agricultural practices, resource management,
                      and climate adaptation strategies, prioritizing
                      reproductive health services, including family planning
                      and maternal care, and providing financial support for
                      girls&apos; education, focusing on STEM subjects to equip
                      them with skills relevant to climate science and
                      sustainability.
                    </p>
                  </div>
                </div>
